...
public class NotesService {
    ...
    public void createNote(String nameNotes, String content, Visibility visibility, UUID userUuid) {
    ...
    public void updateNote(UUID uuid, String nameNotes, String content, Visibility visibility, UUID userUuid) {
